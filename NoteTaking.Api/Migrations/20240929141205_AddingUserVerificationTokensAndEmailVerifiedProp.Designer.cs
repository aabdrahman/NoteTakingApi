...
namespace NoteTaking.Api.Migrations
{
    ...
    [Migration("20240929141205_AddingUserVerificationTokensAndEmailVerifiedProp")]
    partial class AddingUserVerificationTokensAndEmailVerifiedProp
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NoteTaking.Api.Model.UserSummary", b =>
                {
                    b.Property<int>("Number_Of_Notes")
                        .HasColumnType("int");
                    ...
                    b.ToView("UserNoteSummaryView", (string)null);
                });

            modelBuilder.Entity("NoteTaking.Api.Model.UserVerification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NoteTaking.Api.Model.UserVerification", b =>
                {
                    b.HasOne("NoteTaking.Api.Model.User", "user")
                        .WithMany("UserTokenVerifications")
            ...
            modelBuilder.Entity("NoteTaking.Api.Model.User", b =>
                {
                    ...
                    b.Navigation("UserTokenVerifications");
                });
